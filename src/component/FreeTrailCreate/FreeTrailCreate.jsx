        ...
        <div className={styles.container}>
            <div className={styles.leftSidebar}>
                ...
                <div className={styles.rightSidebarContext}>
                    ...
                    <label className={styles.label2}>We will personalize your setup experience accordingly</label>    
                ...
                <div className={styles.formSection}>
                        <div className={styles.leftForm}>
                            <div>
                                ...
                                <div className={styles.leftInput}> 
                                    <img src="../../images/mingcute_user-4-fill.svg"  alt="error" />
                        ...
                        <div className={styles.rightForm}>
                            <div>
                                ...
                                <div className={styles.leftInput}> 
                                    <img src="../../images/Group.svg"  alt="error" />
                                    <input type="text" placeholder='CompanyInstitute Name'/> 
                                </div>
                            </div>
                        ...
                        <div className={styles.phoneSection}>
                            ...
                            <div>
                                <label>Country</label>
                                <div className={styles.leftInput}> 
                                    <img src="../../images/fluent-mdl2_world.svg"  alt="error" />
